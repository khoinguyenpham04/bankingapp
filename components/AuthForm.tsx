                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <div className="flex gap-4">
                                        <CustomInput 
                                            control = {form.control} name={"state"} label={"State"} placeholder={"Example: CA"}
                                        />

                                        <CustomInput 
                                            control = {form.control} name={"postalCode"} label={"Postal Code"} placeholder={"Example: 90001"}
                                        />
                                    </div>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput 
                                            control = {form.control} name={"ssn"} label={"SSN"} placeholder={"Enter your SSN"}
                                        />                       
                                    </div>
                                </>
                            )}
